    ...
    <div style={styles.container}>
      ...
      <div style={styles.grid}>
        <div style={styles.statCard}>
          <div style={styles.iconBox("56, 189, 248")}>
            {" "}
            <FolderGit2 size={28} />{" "}
          </div>
          <div>
            <h2 style={styles.statNumber}>{stats.projects}</h2>
            <div style={styles.statLabel}>Active Projects</div>
          </div>
        </div>
        <div style={styles.statCard}>
          <div style={styles.iconBox("168, 85, 247")}>
            {" "}
            <Cpu size={28} />{" "}
          </div>
          <div>
            <h2 style={styles.statNumber}>{stats.skills}</h2>
            <div style={styles.statLabel}>Skill Nodes</div>
          </div>
        </div>
        <div style={styles.statCard}>
          <div style={styles.iconBox("34, 197, 94")}>
            {" "}
            <Briefcase size={28} />{" "}
          </div>
          <div>
            <h2 style={styles.statNumber}>{stats.experience}</h2>
            <div style={styles.statLabel}>Experiences</div>
          </div>
        </div>
        <div style={styles.statCard}>
          <div style={styles.iconBox("239, 68, 68")}>
            {" "}
            <Mail size={28} />{" "}
          </div>
          <div>
            <h2 style={styles.statNumber}>{stats.messages}</h2>
            <div style={styles.statLabel}>Inbox Messages</div>
          </div>
        </div>
      </div>
      ...
      >
        <div>
          <h3 style={styles.sectionTitle}>
            <MessageSquare size={20} /> Recent Inbox Activity
          </h3>
        ...
        <div>
          ...
          <div style={styles.actionsGrid}>
            <Link to="/admin/projects" style={styles.actionBtn}>
              <FolderGit2 /> Add Project
            </Link>
            <Link to="/admin/skills" style={styles.actionBtn}>
              <Cpu /> Add Skill
            </Link>
            <Link to="/admin/experience" style={styles.actionBtn}>
              <Briefcase /> Add Experience
            </Link>
            <Link to="/admin/certifications" style={styles.actionBtn}>
              <Award /> Add Certification
            </Link>
            <Link to="/admin/profile" style={styles.actionBtn}>
              <User /> Public Identity
            </Link>
            <Link to="/admin/contact-info" style={styles.actionBtn}>
